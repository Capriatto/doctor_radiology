...
class doctor_patient(osv.osv):
	...
	_columns = {
		'attentions_radiology_ids': fields.one2many('doctor.attentions.radiology', 'patient_id', 'Atenciones Radiología'),
	}
	...
	def atender_paciente_radiology(self, cr, uid, ids, context=None):
		try:
			...
			_logger.info("Error en doctor_patient_radiology ===>  %s", e)
